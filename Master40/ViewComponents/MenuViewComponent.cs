...
namespace Master40.ViewComponents
{
    public class MenuViewComponent : ViewComponent
    {
        ...
        public MenuViewComponent()
        {
            ...
            _menu.MenuItems.Add(new MenuItem { MenuItemId = 12, MenuId = 1, MenuText = "Planning & Simulations", LinkUrl = "SimulationConfigurations", MenuOrder = 4, Action = "Index", Symbol = "fa-spinner", Children =
                new List<MenuItem>
                {
